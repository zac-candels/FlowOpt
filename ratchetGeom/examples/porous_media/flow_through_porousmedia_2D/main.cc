...
// This script simulates two phase flow through a porous structure in 2D.
// This example shows how to:
//      (i) pass the geometry to the lattice,
//      (ii) use saveBoundariesVTK and saveBoundariesDAT to save the geometry, and
//      (iii) use saveVTK and saveDAT to save the simulation data.
