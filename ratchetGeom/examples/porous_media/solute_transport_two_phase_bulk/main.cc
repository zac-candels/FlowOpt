...
// This script simulates two-phase flow with solute transport in a 2D bulk domain.
// This example shows how to use SoluteRepulsiveForce to model solute presence in a two-phase system.

const int lx = 100;  // Size of domain in x direction
const int ly = 100;  // Size of domain in y direction

const int timesteps = 400000;   // Number of iterations to perform
