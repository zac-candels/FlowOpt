...
auto initPressure() {
    ...
    FlowFieldPressureWellBalanced2<Lattice, DefaultTraitPressureWellBalancedN2<3,Lattice>> pressure;
...
auto initTernary() {
    ...
    using Trait = typename std::conditional<
        N == 0, typename DefaultTraitWellBalancedCH<N,3,Lattice>::template AddProcessor<ChemicalPotentialCalculatorTernaryLee>,
