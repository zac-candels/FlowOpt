...
auto initPressure() {
    ...
    FlowFieldPressureWellBalanced<Lattice, DefaultTraitPressureLiangN<3,Lattice>> pressure;
    ...
    pressure.getForce<LiangMomentumCorrection>().setRhos(1.0, 1.0, 1.0);
    pressure.getForce<LiangMomentumCorrection>().setMobility(1.0/6.0, 1.0/6.0);
...
auto initTernary1() {
    ...
    LiangCH<0, 3, Lattice, DefaultTraitLiangCH1<0,3,Lattice>> ternary;
...
auto initTernary2() {
    ...
    // WellBalancedCH is the model class, and we give the lattice and traits as template parameters.
    LiangCH<1, 3, Lattice, DefaultTraitLiangCH2<1,3,Lattice>> ternary;
...
int main(int argc, char **argv) {
    ...
    auto ternary1 = initTernary1();
    auto ternary2 = initTernary2();
