...
# Usage
path = "/home/zcandels/LBM/examples/binary/superhydrophobic_wellbalanced/input.txt"
...
datadir = "../examples/binary/superhydrophobic_wellbalanced/data/"
...
x_n = 0
centroid_pos = []
for n_idx in range(10, Num_steps, 1):
...
vel = 0
for i in range(1, len(centroid_pos) - 1 ):
    vel = ( centroid_pos[i+1] - centroid_pos[i-1] )/2
    print("vel = ", np.abs(vel))
