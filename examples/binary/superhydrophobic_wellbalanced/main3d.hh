...
auto initBinary() {
    ...
    double wettingprefactor_right; 
    double wettingprefactor_left;
    
    wettingprefactor_right = -2 * cos(90 * M_PI / 180.0) * sqrt(2 * A / kappa);
    wettingprefactor_left = -2 * cos(30 * M_PI / 180.0) * sqrt(2 * A / kappa);

    //binary.template getProcessor<orderparamgradients>().setWettingPrefactor( wettingprefactor2 );
    
    binary.template getProcessor<orderparamgradients>().setWettingPrefactor({1,2}, {wettingprefactor_left, wettingprefactor_right});
