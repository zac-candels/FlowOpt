...
// This script simulates 2D Young-Laplace test. Check the Verification.xlsx for the expected results.
...
const double dropRadius = 0.3 * lx;  // Radius to initialise the droplet
